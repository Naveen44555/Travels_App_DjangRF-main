...
#     Token is used for:
        ...
        # Without token → API denies access

class LoginView(APIView):   #This handles authentication.APIView → REST API view
    def post(self, request):    #Runs when React sends POST request.
